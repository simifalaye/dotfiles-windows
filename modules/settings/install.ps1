...
Write-Info ":: Configuring Privacy..."
...
Write-Info ":: Configuring Explorer, Taskbar, and System Tray..."
...
# Taskbar: Hide the Search, Task, and Chat buttons: Show: 1, Hide: 0
